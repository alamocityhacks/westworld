export default function Profile({
    ...
    return (
        <a href={`mailto:${username}@alamocityhacks.com`} target="_blank" className={`flex flex-row space-x-4 blacklink ${extraclasses}`}>
            <div className="hidden sm:block pointer-events-none max-w-profile-sm lg:max-w-none lg:min-w-profile">
            ...
            <div className="font-inter pt-2 md:pt-0 lg:pt-6 pointer-events-none">
                ...
                <div className="md:hidden text-sm mb-2 w-4/5">{shortdescription}</div>
